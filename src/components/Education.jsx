    ...
    <section id="education" className="section" style={{ background: 'var(--bg-2)' }}>
      <div className="container">
        <div style={{ marginBottom: '56px' }} className="reveal">
          ...
          <h2 className="section-title">Academic<br /><span>Background</span></h2>
          <div className="accent-line" />
        </div>

        <div className="resp-grid-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px', alignItems: 'start' }}>
          {/* Degree card */}
          <div className="reveal-left">
            <div style={{
              ...
              onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--accent)'; e.currentTarget.style.boxShadow = '0 20px 60px rgba(0,0,0,0.4)' }}
            ...
            >
              ...
              <div style={{ position: 'absolute', top: 0, right: 0, width: '120px', height: '120px', background: 'radial-gradient(circle at top right, rgba(200,255,0,0.05), transparent)', pointerEvents: 'none' }} />

              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'var(--accent)', background: 'var(--accent-dim)', border: '1px solid var(--border)', padding: '5px 12px', borderRadius: '4px', marginBottom: '20px', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                🎓 Bachelor's Degree
              </div>

              <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(36px,5vw,52px)', color: 'var(--text-primary)', letterSpacing: '0.03em', lineHeight: 1, marginBottom: '10px' }}>BCA</h3>
              <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginBottom: '4px', fontWeight: 500 }}>Bachelor of Computer Applications</div>
          ...
          <div className="reveal-right">
            ...
            {internships.map((intern, i) => (
              <div key={i} className="hoverable" style={{
                padding: 'clamp(20px,3vw,28px)', background: 'var(--surface)', border: '1px solid var(--border)',
                borderRadius: 'var(--radius-lg)', marginBottom: '14px', transition: 'all 0.3s ease',
                position: 'relative', overflow: 'hidden',
              }}
                onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--accent-2)'; e.currentTarget.style.transform = 'translateX(4px)' }}
